/*
7. Implemente uma função de protótipo int lst_remover_menores(lista * l,
...
int main() {
    ...
    do {
        ...
        printf("<11> Remover no final da lista\n");
        printf("<12> Remover no inicio da lista\n");
        printf("<13> Gerar conteudo aleatoriamente na lista\n");
        printf("<14> Verificao da ordenacao crescente\n");
        printf("<15> Remover nos menores que um determinado numero\n");
        printf("<0> Sair\n");
        printf("Opcao: ");
        scanf("%d", &op);
        ...
        case 11:
            printf("\n\nRemover um no, porem no final da lista\n");
            if (lst_remover_final(&l,&val)) {
                printf("%d removido do final da lista!\n", val);
            } else {
        ...
        case 12:
            printf("\n\nRemover um no, porem no incio da lista\n");
            if (lst_remover_inicio(&l,&val)) {
                printf("%d removido do inicio da lista!\n", val);
            } else {
                printf("Erro: lista vazia!\n");
            }
            break;
        ...
        case 13:
            printf("\n\nGerar aleatoriamente o conteudo da lista\n");
            printf("\nInforme a quantidade de nos desejada: ");
            scanf("%d", &k);
            printf("Informe o valor maximo dos valores a serem gerados: ");
            scanf("%d", &val);
            if (lst_gerar(&l,k,val)) {
                printf("\nConteudo gerado com sucesso!");
            } else {
                printf("\nErro: a quantidade de nos desejada é maior que o tamanho do vetor).!\n");
            }
            break;

        case 14:
            printf("\n\nVerificacao da lista: ");
            if (lst_ordenada(l)) {
                printf("\nA lista esta ordenada em ordem crescente!");
            } else {
                printf("\nA lista NAO esta ordenada em ordem crescente!");
            }
            break;
        ...
        case 15:
            ...
            printf("\n\nInforme o numero: ");
            scanf("%d", &val);
            printf("\nNumero de nos removidos: %d", lst_remover_menores(&l,val));
            break;
